...
l4 = mx.sym.FullyConnected(data = a3, num_hidden = 26752, weight = w, name = 'output')
#cost_classification = mx.sym.SoftmaxOutput(data = l4, label = label)
net = l4.simple_bind(ctx = dev, grad_req = 'write', data = dshape)
#print 'net is okay'

# Data structure
arg_names = l4.list_arguments()
