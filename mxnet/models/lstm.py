...
def build_function(vocab_size=10000, seq=32, num_level = 2, hiddenLayDim=256, embedding_size = 256):
    featureDim = (seq, )
    labelDim = vocab_size

    def build_model():
        return lstm_unroll(num_level, seq, vocab_size,
                           num_hidden=hiddenLayDim, num_embed=embedding_size,
                           num_label=labelDim)
