...
python rnn/lstm_bucketing.py --batch-size ${RMBS} --num-batch ${RNB} --seq-len 32 --data-path "../cntk/rnn/PennTreebank/Data" 2>&1 | tee output_lstm32.log
python rnn/lstm_bucketing.py --batch-size ${RMBS} --num-batch ${RNB} --seq-len 64 --data-path "../cntk/rnn/PennTreebank/Data" 2>&1 | tee output_lstm64.log	
