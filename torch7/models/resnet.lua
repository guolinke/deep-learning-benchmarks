...
local function createModel(batch_size, deviceId)
   ...
   local function ConvInit(name)
      for k,v in pairs(model:findModules(name)) do
         ...
         if deviceId >=0 and cudnn.version >= 4000 then
            v.bias = nil
            v.gradBias = nil
         else
            v.bias:zero()
   ...
   return model, 'Resnet', {batch_size,3,224,224}, batch_size, n_classes
end
